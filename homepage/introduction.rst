...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first movement of the first quartet, op. 12 has the following files:
